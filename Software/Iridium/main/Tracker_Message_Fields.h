...
#define SEND_BIG_PACKET_SPREAD_MS 100000000
#define GPS_BUFFER_DELAY_MS 5000
#define TRANSMIT_LOOPS_SLEEP_MS 10
...
#define DEF_FLAGS1    0x80 // Default to text messages
#define DEF_FLAGS2    0
#define DEF_DEST      0
